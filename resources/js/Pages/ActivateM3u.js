...
Today
            ...
            <div class="relative mt-4"><label class="absolute px-2 ml-2 -mt-3 font-medium text-gray-600 bg-white">id4k</label><input name="text" type="text" class="block w-full px-4 py-4 mt-2 text-base placeholder-gray-400 bg-white border border-gray-300 rounded-md focus:outline-none focus:border-black" placeholder="id4k" value=""/></div>

            <div class="relative mt-4"><label class="absolute px-2 ml-2 -mt-3 font-medium text-gray-600 bg-white">username</label><input name="text" type="text" class="block w-full px-4 py-4 mt-2 text-base placeholder-gray-400 bg-white border border-gray-300 rounded-md focus:outline-none focus:border-black" placeholder="4k username" value=""/></div>


            <div class="relative mt-4"><label class="absolute px-2 ml-2 -mt-3 font-medium text-gray-600 bg-white">password</label><input name="text" type="text" class="block w-full px-4 py-4 mt-2 text-base placeholder-gray-400 bg-white border border-gray-300 rounded-md focus:outline-none focus:border-black" placeholder="4k password" value=""/></div>

            <button class="bg-green-600 mt-4 w-full px-4 py-4 text-white  uppercase mb-4 mx-auto">  Activate</button>
