    ...
    <div className="px-12">
      <div className="row align-items-center">
        <div className="col-12 col-md">
          <h1 className="text-4xl lg:text-6xl mb-1 mt-5 font-semibold">
            How to install iptv on android smart tv
          </h1>
      ...
      <div className="grid gap-4 grid-cols-12">
        <div className="col-span-12 md:col-span-8 mb-md-0 mb-5 leading-8">
          ...
          <p className="mb-2 text-gray-800">1- Open Google Play Store</p>
          <p className="mb-2 text-gray-800">2- Search for <a className="underline text-blue-500" href="https://play.google.com/store/apps/details?id=com.nst.iptvsmarterstvbox">"IPTV Smarters PRO"</a> and install it</p>
