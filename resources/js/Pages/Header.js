    ...
    <div className="   flex justify-between ">
        ...
        <div>
         ...
         <div className="   hidden md:flex items-center space-x-1">
          ...
          <a href="#" className="   py-5 px-3 font-medium font-sans text-black hover:text-primary transition-colors">Channels List</a>
...
<a href="#" className="   py-5 px-3 font-medium font-sans text-black hover:text-primary transition-colors">Free Trial</a>
...
<span>{txt}</span>
 ...
 <a href="#" className="   block py-2 px-4 text-sm  font-medium font-sans text-black hover:text-primary transition-colors">Channels List</a>
 ...
 <a href="#" className="   block py-2 px-4 text-sm  font-medium font-sans text-black hover:text-primary transition-colors">Free Trial</a>
