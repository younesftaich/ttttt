    ...
    <div className="px-12">
      ...
      <div className="grid gap-4 grid-cols-12">
        <div className="col-span-12 md:col-span-8 mb-md-0 mb-5 leading-8">
          ...
          <p className="text-gray-800">
            3- go back to the Downloader app. On the app’s initial page you’ll see a white box into which you can type a URL. Select it and type in: <br /> <span className="text-blue-500">http://thenetflytv.com/sm</span><br /> Then install it.
          </p>
        ...
        <div className="col-span-12 md:col-span-4" id="contact-us">
          <div className="rounded-md p-5" style={{borderWidth: '1px'}}>
            <h4>
              Need an IPTV Subscription ? <a href="/checkout" className="text-blue-500 underline">Order Now</a><main>
                <section className="pt-8 pt-md-11 pb-8 pb-md-14">
                  <div className="px-12">
                    <div className="row align-items-center">
                      <div className="col-12 col-md">
                        <h1 className="text-4xl lg:text-6xl mb-1 mt-5 font-semibold">
                          How to install iptv on ios
                        </h1>
                        <a href="/installation" className="text-blue-500 text-sm pb-3 flex items-center space-x-2">
                          <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11 17l-5-5m0 0l5-5m-5 5h12" />
                    ...
                    <div className="grid gap-4 grid-cols-12">
                      <div className="col-span-12 md:col-span-8 mb-md-0 mb-5 leading-8">
                        ...
                        <h3 className="mb-3 text-lg font-semibold">
                          IPTV Smarters PRO Application (APP 1)
                        </h3>
                        <p className="mb-2 text-gray-800">1- Open App Store</p>
                        <p className="mb-2 text-gray-800">2- Search for <a className="underline text-blue-500" href="https://apps.apple.com/us/app/iptv-smarters-player/id1383614816">"IPTV Smarters PRO"</a> and install it</p>
                        ...
                        <img className="my-3 rounded-md" src="https://thenetflytv.com/images/how-to-install-iptv/iptv-smarters-pro-ios-login.png" alt="Smarters Iptv Pro Application Login Interface" />
                        ...
                        <img className="my-3 rounded-md" src="https://res.cloudinary.com/luxiptv/image/upload/v1644951453/smarters-pro-application-running_1_qcfu0g.jpg" alt="Smarters Iptv Pro Application Running" />
                        <hr className="my-8" />
                        <h3 className="mb-3 text-lg font-semibold">
                        ...
                        <p className="mb-2 text-gray-800">
                          ...
                          Download for iOS devices: <a className="underline text-blue-500" href="https://apps.apple.com/app/gse-smart-iptv/id1028734023">apps.apple.com</a> <br />
                        </p>
                        <p className="mb-2 text-gray-800">
