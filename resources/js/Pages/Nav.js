    ...
    <div className="   flex justify-between ">
        ...
        <div>
         ...
         <div className="   hidden md:flex items-center space-x-1">
          ...
          <a href="/countries" className="   py-5 px-3 font-medium font-sans text-black hover:text-primary transition-colors">Channels List</a>
          <a href="/installation" className="   py-5 px-3 font-medium font-sans text-black hover:text-primary transition-colors">Installation Tutorials</a>
          <a href="/checkout" className="   py-5 px-3 font-medium font-sans text-black hover:text-primary transition-colors">See Pricing</a>
      ...
      <div className="   hidden md:flex items-center space-x-1">
        ...
        <a href={link2} className="   py-5 px-3 font-medium font-sans text-black hover:text-primary transition-colors">{txt2}</a>
...
<span>{txt}</span>
 ...
 <a href="/countries" className="   block py-2 px-4 text-sm  font-medium font-sans text-black hover:text-primary transition-colors">Channels List</a>
 <a href="/installation" className="   block py-2 px-4 text-sm  font-medium font-sans text-black hover:text-primary transition-colors">Installation Tutorials</a>
 <a href="/checkout" className="   block py-2 px-4 text-sm  font-medium font-sans text-black hover:text-primary transition-colors">See Pricing</a>
    
    <a href={link2} className="   block py-2 px-4 text-sm  font-medium font-sans text-black hover:text-primary transition-colors">{txt2}</a>
